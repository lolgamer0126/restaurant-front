  ...
  export default function EditRestaurant() {
    ...
    useEffect(()=>{
        fetchRestaurantDetails(id!).then(res=> {
         if(res.message=='error')
             ...
             setValues(res.restaurant);
         
        })
    },[])

    useTitle('Ресторан засах')
    const { id } = useParams();
    ...
    const handleSubmit = async (event:any, ) =>{
        ...
        if(res.message=='error'){
            toast({
                title: 'Алдаа гарлаа',
                description: "Та бүх нүдийг бүрэн бөглөнө үү",
                status: 'error',
                duration: 9000,
                isClosable: true,
              })
        }
        if(res.message=='admin privilage required'){
          toast({
              title: 'Алдаа гарлаа',
              description: "Зөвхөн админ шинээр ресторан үүсгэнэ!",
              status: 'error',
              duration: 9000,
              isClosable: true,
            })
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="text" value={values.name || ''} name="name" placeholder="Рестораны нэр"
                    ...
                    <InputGroup>
                      ...
                      />
                      <Input type='tel' value={values.phone || ''} placeholder='Phone number' 
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<HiOutlinePhotograph />} />
                        <Input
                          value={values.photo || ''}
                          type="text"
                          name="email"
                          placeholder="Рестораны зураг(URL)"
                    ...
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        <InputLeftElement children={<BiCategoryAlt />} />
                        <Input
                          value={values.tags || ''}
                          type="text"
                          name="email"
                          placeholder="Ангилалууд(таслалаар зааглагдана)"
                    ...
                    <FormControl>
                      ...
                      <Select value={values.branch || ''} placeholder='Салбарын тоо сонгох' onChange={e=>{
                    ...
                    <FormControl isRequired>
                      ...
                      <Textarea
                        ...
                        name="message"
                        placeholder="Рестароны дэлгэрэнгүй мэдээлэл"
                        rows={6}
                        resize="none"
